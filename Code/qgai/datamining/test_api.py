...
#     key = "bce-v3/ALTAK-QWpz6rTDbyF8IlgtlQQj0/fc287128eebbc710bd4e2ae1ba5b16ad29b91469"
#
#     prompt = f"""
#     你是一个流程精简专家，请严格按以下规则处理：
#     1. 仅保留与用户特征直接相关的步骤
...
#             }
#         ],
#         "temperature": 0.,  # 降低随机性，加速响应
#         "max_tokens": 500,  # 限制输出长度，避免冗余计算
#         "stream": False,  # 禁用流式输出，减少处理时间
#         "web_search": {
#             "enable": False,
